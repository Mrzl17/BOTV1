...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('bang zul', {
		font: 'Standard',
	...
	console.log(color('[ GO 2K FOLLOWERS ]\n', 'yellow'), color('follow zl_barmawi', 'yellow'))
	console.log(color('GA FOLLOW BAKAL EROR:V', 'pink'))
	console.log(color('\n\n[ FOLOW IG @zl_barmawi', 'red'))
	dha.browserDescription = ["bang zul", "Chrome", "3.0.0"];
	...
	dha.on('connecting', () => {
		console.log(color('[ Bang zul botz ]', 'black'), color('PROSES NYAMBUNG...'));
	})
const spinner = { 
  "interval": 120,
  "frames": [
	...
	//connect
	dha.on('open', () => {
		console.log(color('[ bang zul botz ]', 'yellow'), color('BOT SUDAH AKTIF'));
	})
