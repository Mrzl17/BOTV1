...
petik = '```'
fake = '©Bang Zul botz'//GANTI NAMA KAMU BEP
ban =[]
...
*Sewa bot?* Chat wa.me/6282348215442`
       ...
       case 'othercmd':
               ...
               const yy = {title: 'Silahkan di pilih' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        footerText: 'case by bang Zul', imageMessage: imageMsg,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
               ...
               listmsg(from, `${ucapanWaktu}`,   `Subscribe https://youtube.com/Zllimtz`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
//------------------< by Bang Zul  >-------------------  
case 'audio1':
man = fs.readFileSync('./Bang Zul/audio1.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio2':
man = fs.readFileSync('./Bang Zul/audio2.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio3':
man = fs.readFileSync('./Bang Zul/audio3.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio4':
man = fs.readFileSync('./Bang Zul/audio4.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio5':
man = fs.readFileSync('./Bang Zul/audio5.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio6':
man = fs.readFileSync('./Bang Zul/audio6.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio7':
man = fs.readFileSync('./Bang Zul/audio7.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
//------------------< bayar menu >-------------------  
case 'bayar':
...
*Chat Owner :* wa.me/6282348215442`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
*ID Guild :* -
*Minat Join? Chat* wa.me/6282348215442
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId:`${prefix}Bang Zul botz`,buttonText:{displayText:'Putpay BOT'},type:1}]
...
"sellerJid": "6282348215442@s.whatsapp.net",
...
"businessOwnerJid": "6282348215442@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran Bang ZulBot 」*\n#Ijin Siaran\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": ' ßð†z',
			"buttons": [
...
//------------------< Fun >-------------------
    case 'public':
       ...
       case 'ganteng':
              ...
              teks = `*Masih Gantengan owner gua and yg pling  ganteng kedua adalah:* @${siapss.jid.split('@')[0]}`
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6282348215442@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/zl_barmawi/`)
             break
      case 'grupbot':
...
if (budy.includes(`sticker gua njay`)) {
const rell = fs.readFileSync('./herman/sticker gua njay.mp3');
dha.sendMessage(from, rell, MessageType.audio, {quoted: mek,mimetype:'audio/mp4',ptt:true})
